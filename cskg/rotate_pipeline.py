...
def main():
    ...
    predict_host_cve_relations(entity2id, rel2id, rotate_model, threshold=-15, top_k=20)

    rgcn, data = train_rgcn(entity2id, rel2id, triplets_df)
    classify_hosts(rgcn, data, entity2id)

    # ✅ Évaluation avec les mêmes entités que l’entraînement
    test_df = triplets_df.sample(frac=0.2, random_state=42)
